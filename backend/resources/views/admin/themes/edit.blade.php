...
@section('page_subtitle', 'Modify theme details and settings')

@section('content')
<div class="max-w-2xl mx-auto space-responsive">
    <div class="premium-card">
        <form method="POST" action="{{ route('admin.themes.update', $theme) }}" class="padding-responsive">
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $theme->name) }}" 
                ...
                <div>
                    ...
                    <input type="text" id="name_ta" name="name_ta" value="{{ old('name_ta', $theme->name_ta) }}" 
                ...
                <div class="form-grid-full">
                    ...
                    <textarea id="description" name="description" rows="3" 
                              ...
                              placeholder="Describe this theme and what kind of content it includes">{{ old('description', $theme->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-danger-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="icon" name="icon" value="{{ old('icon', $theme->icon) }}" 
                ...
                <div>
                    ...
                    <input type="color" id="color" name="color" value="{{ old('color', $theme->color ?? '#3b82f6') }}" 
                ...
                <div>
                    ...
                    <input type="number" id="order_index" name="order_index" value="{{ old('order_index', $theme->order_index) }}" 
            ...
            <div class="mt-8 p-4 bg-slate-50 rounded-lg">
                <div class="flex items-center justify-between text-sm">
                    <div>
                        ...
                        <span class="font-medium text-slate-900">{{ $theme->created_at->format('M j, Y \a\t g:i A') }}</span>
                    </div>
                    <div>
                        <span class="text-slate-600">Templates:</span>
                        <span class="font-medium text-slate-900">{{ $theme->templates()->count() }}</span>
                    </div>
                    <div>
                        <span class="text-slate-600">Last Updated:</span>
                        <span class="font-medium text-slate-900">{{ $theme->updated_at->format('M j, Y \a\t g:i A') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-between mt-8 pt-6 border-t border-slate-200">
                <div>
                    <a href="{{ route('admin.themes.duplicate', $theme) }}" class="btn-secondary-premium">
                ...
                <div class="flex space-x-3">
                    <a href="{{ route('admin.themes.show', $theme) }}" class="btn-secondary-premium">
                        Cancel
                    </a>
